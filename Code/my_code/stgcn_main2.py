...
class Task:
    ...
    def prepare_dataloaders(self, coordinate_dim=3, more_label_1=True):
        ds_split_seed = 42
...
if __name__ == '__main__':
    task = Task()
    task.prepare_dataloaders(coordinate_dim=3, more_label_1=True)
    task.get_network_architecture(model_name='stgcn_12')
    task.seek_network_weights(model_info='no_pad_loss', serial_no=1, pick_by_f1_score=True)
